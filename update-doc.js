...
const testFiles = [
	...
	{
		topic: 'Validação de Array de Objetos',
		testPath: 'src/__test__/005.test.ts',
	},
	{ topic: 'Validação de Enums', testPath: 'src/__test__/006.test.ts' },
	{ topic: 'Validação Encadeada', testPath: 'src/__test__/007.test.ts' },
	{
		topic: 'Validação de Estruturas Diferentes com Base em uma Chave',
		testPath: 'src/__test__/008.test.ts',
	},
];
